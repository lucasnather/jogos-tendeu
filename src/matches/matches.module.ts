...
import { UpdateWinnerTeamMatchController } from "./controller/update-winner-team-match.controller";
...
@Module({
    controllers: [UpdateWinnerIndividualMatchController, UpdateWinnerTeamMatchController],
    providers: [
